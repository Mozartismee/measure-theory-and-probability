\sheettitle
  ...
  {Results in $L^p$ retained for later work}

This extract is omitted from the main document by default because the preparatory notes already contain the proofs. It records only the statements needed later.
