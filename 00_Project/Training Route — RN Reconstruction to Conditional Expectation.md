...
module: project
status: canonical
route: rn-reconstruction-to-conditional-expectation
edition: full-mastery
calendar-status: reference-only
start: 2026-07-14
end: 2026-08-16
timezone: Asia/Taipei
---

# Training Route — RN Reconstruction to Conditional Expectation

> **Reference route.** This file preserves the complete five-week mastery sequence and its original nominal dates. It is not an active calendar. The current learning contract is always resolved through [Current Learning State](../Study%20Log/State/CURRENT.md); after a compressed cycle, return only to the proof debts recorded there rather than restarting this sequence mechanically.
