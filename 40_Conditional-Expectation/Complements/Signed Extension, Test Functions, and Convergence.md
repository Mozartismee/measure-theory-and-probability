...
# Complement — Signed Extension, Test Functions, and Convergence

Let $(\Omega,\mathcal F,\mathbb P)$ be a probability space and let $\mathcal G\subset\mathcal F$ be a sub-$\sigma$-field.

This complement isolates the analytic mechanisms required in Exercise 1.2–1.3 of [[40_Conditional-Expectation/TD 01 — RN Construction|TD 01]]. Its scope is deliberately restricted to:
...
Before returning to TD 01, the following should be recoverable without consulting this complement.
