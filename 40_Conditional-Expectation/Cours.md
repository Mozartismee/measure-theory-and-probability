...
This module depends on [[20_Radon-Nikodym/Cours|the Radon–Nikodym construction]].
...
The ambient measure, $L^1$-space and almost-everywhere relation are recorded in [[10_Foundations/Version Discipline|Version Discipline]].
...
Conditioning on a random variable and conditional event laws belong to [[50_Conditional-Laws/Cours|Conditional Laws]].
