...
- Object：product measures、Tonelli、Fubini、joint and marginal laws、change of variables。
- Purpose：補上目前 Integration 與 joint-law applications 之間的正式結構缺口。
- Regime：ENS 理論主線與 Exam P continuous transformation 核心。
